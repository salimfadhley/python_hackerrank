...
def cov(l:Sequence, k:int):
    ...
    while True:
        ...
        possible_transmitter_locations = l[:bisect.bisect_right(l, furthest_possible_transmitter_address)]
        transmitter_location = max( a for a in possible_transmitter_locations if a -k <= first_address)
